...
Ext.extend(Testopia.TestPlan.Grid, Ext.grid.GridPanel, {
    ...
    newCase: function(){
        var form = new Ext.form.BasicForm('testopia_helper_frm', {});
        var p = {plan_id: Testopia.Util.getSelectedObjects(this, 'plan_id'), action: 'check_plan_rights'};
        var records = Testopia.Util.getSelectedObjects(this, 'plan_id')
    ...
    Testopia.TestRun.NewRunForm.superclass.constructor.call(this, {
        ...
        buttons: [{
            ...
            handler: function(){
                ...
                if (Ext.getCmp('build_combo').selectedIndex == -1) {
                    values.new_build = Ext.getCmp('build_combo').getValue();
                }
                if (Ext.getCmp('environment_combo').selectedIndex == -1) {
                    values.new_env = Ext.getCmp('environment_combo').getValue();
                }
